...
String version() {
    return "v3.9.0.20260407"
}

/*
 * 07-Apr-2026 >>> v3.9.0.20260407 - Add automatic 1-minute polling during grid outages to detect grid return without external rule.
 *                                    Fix bitwise & bug in getWhenString month condition. Fix schedVal(item) scope bug in schedule
 *                                    completion check (GridStatus). Fix unit vs units typo in driver sendEventIfChanged.
    ...
    if (state.scheduleDeleted) {
        ...
        dynamicPage(name: "pageScheduleOptions", title: schedNameFromIndex(schedIndex), install: false, uninstall: false) { 
            ...
            section("Select Powerwall actions to apply:") {
               ...
               Boolean complete = actionsValid(schedVal(schedNum,"Mode"), schedVal(schedNum,"Reserve"),schedVal(schedNum,"Stormwatch"),schedVal(schedNum,"GridCharging"), null, schedVal(schedNum,"GridStatus"))
...
void processOffGridActions() {
    ...
    runEvery1Minute(processOutagePoll)
    logger ("Started 1-minute outage polling to detect grid return","info")
}

void processOnGridActions() {
    logger ("processing on grid actions","debug")
    unschedule(processOutagePoll)
    logger ("Stopped outage polling - grid restored","info")
    def child = getPwDevice()
...
void processOutagePoll() {
    logger ("Outage poll: checking for grid return","debug")
...
// Icons
@Field static final String teslaIcon = "https://raw.githubusercontent.com/DarwinsDen/SmartThingsPublic/master/resources/icons/Tesla-Icon40.png"
@Field static final String gatewayIcon = "https://raw.githubusercontent.com/DarwinsDen/SmartThingsPublic/master/resources/icons/gateway.png"
@Field static final String notifyIcon = "https://raw.githubusercontent.com/DarwinsDen/SmartThingsPublic/master/resources/icons/notification40.png"
@Field static final String batteryIcon = "https://raw.githubusercontent.com/DarwinsDen/SmartThingsPublic/master/resources/icons/battery40.png"
@Field static final String outageIcon = "https://raw.githubusercontent.com/DarwinsDen/SmartThingsPublic/master/resources/icons/outage40.png"
...
@Field static final String cogIcon = "https://raw.githubusercontent.com/DarwinsDen/SmartThingsPublic/master/resources/icons/cogD40.png"
@Field static final String dashIcon = "https://raw.githubusercontent.com/DarwinsDen/SmartThingsPublic/master/resources/icons/dashboard40.png"
@Field static final String schedIcon = "https://raw.githubusercontent.com/DarwinsDen/SmartThingsPublic/master/resources/icons/schedClock40.png"
@Field static final String schedOkIcon = "https://raw.githubusercontent.com/DarwinsDen/SmartThingsPublic/master/resources/icons/schedOk40.png"
@Field static final String addIcon = "https://raw.githubusercontent.com/DarwinsDen/SmartThingsPublic/master/resources/icons/add40.png"
@Field static final String schedIncomplIcon = "https://raw.githubusercontent.com/DarwinsDen/SmartThingsPublic/master/resources/icons/schedIncompl40.png"
...
@Field static final String trashIcon = "https://raw.githubusercontent.com/DarwinsDen/SmartThingsPublic/master/resources/icons/trash40.png"
